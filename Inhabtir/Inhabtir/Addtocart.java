...
public class Addtocart {
	...
	public void Criflow1() throws InterruptedException {
		...
		//new Actions(driver).moveToElement(driver.findElement(By.xpath("//label[contains(text(),'Credit Card Number')]"))).click().sendKeys("4242 4242 4242 4242").build().perform();
		...
		//new Actions(driver).moveToElement(driver.findElement(By.xpath("Rel XPath //button[@id='bankAccount']"))).click().perform();
		
		//driver.findElement(By.xpath("Rel XPath //button[@id='bankAccount']")).click();
		...
		/*new Actions(driver).moveToElement(driver.findElement(By.xpath("//label[contains(text(),'Credit Card Number')]"
				))).click().sendKeys("0 4 2 4 2 4242 4242 4242").build().perform();
